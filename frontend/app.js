...
define(['jquery', 'helpers', 'handlebars', 'handlebarsHelpers', 'noteController', 'noteService', 'dashboardController'], function ($, helpers, Handlebars, handlebarsHelpers, noteController, noteService, dashboardController){
    ...
    return {
        ViewController: {
            ...
            deleteNote: function (noteId) {
                ...
                $.when(noteService.deleteNote(noteId)).done(function(notes){
                    console.log('delete');
            ...
            showNoteAdd: function () {
                ...
                noteController.renderView(data);
            },
